...
import { SiTailwindcss, SiJavascript, SiKonva, SiReact, SiSupabase } from "react-icons/si";
...
export default function Projects() {
  ...
  // Configuración de contadores DEV
  const devCounters = [
    { value: 8, label: t("webApps"), suffix: "+" },
    { value: 15, label: t("components"), suffix: "+" }
  ];
  ...
  return (
    <section id="projects" className="mb-[100px] flex flex-col justify-center items-center bg-white dark:bg-black text-gray-900 dark:text-gray-100 p-8">
      ...
      <div className="w-full max-w-4xl mx-auto mb-16">
        ...
        <div className="w-full max-w-2xl mx-auto px-8">
          ...
          >
            ...
            {/* Card QA 2: Placeholder para futuros proyectos QA */}
            <SwiperSlide>
              <div className="bg-gray-900 rounded-xl shadow-lg overflow-hidden flex flex-col items-center justify-center p-6 min-h-[500px] group">
                <div className="text-center">
                  <h3 className="text-2xl font-bold mb-4 text-white">QA Methodologies</h3>
                  <p className="text-gray-300 mb-8">Testing frameworks and approaches I use</p>
                  <div className="grid grid-cols-2 gap-4 text-sm text-gray-400">
                    <div>• Manual Testing</div>
                    <div>• Automated Testing</div>
                    <div>• API Testing</div>
                    <div>• Performance Testing</div>
                    <div>• Exploratory Testing</div>
      ...
      <div className="w-full max-w-4xl mx-auto mb-16">
        {/* Título Desarrollo */}
        <motion.h3 
          className="text-3xl font-bold text-center mb-8 text-green-600 dark:text-green-400"
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.6 }}
          viewport={{ once: true }}
